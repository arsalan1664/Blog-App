...
<div className="flex flex-col justify-center items-center h-[100vh]">
    <div className="flex w-full flex-col rounded-md bg-cover px-[30px] py-[30px] md:px-[64px] md:py-[56px] max-w-[95%] xl:max-w-[800px] "
        style={
            {
    ...
    <p className="font-normal text-navy-700 mt-20 mx-auto w-max">
        ...
        <a href="https://horizon-ui.com?ref=tailwindcomponents.com" target="_blank" className="text-brand-500 font-bold">
